...
\parbox{\dimen255}
{%
\rule[-0.5ex]{0pt}{2.5ex}\hspace*{0.0em}\textcolor{G}{\textbf{\%~Hoehe~der~Textzeile}}\\
\rule[-0.5ex]{0pt}{2.5ex}\hspace*{0.0em}\textbackslash{}node[\textcolor{R}{\textbf{text~height=3ex}}]~at~(0,~0)~\{Donald~E.~Knuth\};}%
}%
\endgroup
