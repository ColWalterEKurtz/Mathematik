...
\parbox{\dimen255}
{%
\rule[-0.5ex]{0pt}{2.5ex}\hspace*{0.0em}\textcolor{G}{\textbf{\%~ein~ziemlich~dicker~Strich}}\\
\rule[-0.5ex]{0pt}{2.5ex}\hspace*{0.0em}\textbackslash{}draw[\textcolor{R}{\textbf{line~width=5mm}}]~(0,~0)~{-}{-}~(3,~0);}%
}%
\endgroup
