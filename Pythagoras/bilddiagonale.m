...
hoeheC   = 9 * fac169;
breiteC  = 16 * fac169;
diagC169 = sqrt(breiteC^2 + hoeheC^2);
...
printf("      \\item Bei gleicher Breite ist die Fläche des 16:9 Bildschirms \\pc{25}\n");
printf("            kleiner als die Fläche des Bildschirms im 4:3-Format:\\par\n");
...
printf("              \\par\n");
printf("              \\begin{equation*}\n");
printf("                \\frac{16y\\cdot9y}{4x\\cdot3x}\n");
printf("                =\n");
printf("                \\frac{4x\\cdot\\frac{9x}{4}}{4x\\cdot3x}\n");
printf("                =\n");
printf("                \\frac{3}{4}\n");
printf("                =\n");
printf("                \\pc{75}\n");
...
printf("            Das Bild eines 16:9 Films nimmt also nur \\pc{75} der\n");
printf("            Flache eines 4:3 Bildschirms ein.\n");
