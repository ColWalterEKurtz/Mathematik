...
printf("      \\item genau zehn Schnittpunkte aufweist;\n");
printf("      \\item genau elf Schnittpunkte aufweist.\n");
printf("      \\item Ist es möglich, eine Figur aus zwei Kreisen und zwei Geraden mit elf\n");
printf("            Schnittpunkten zu zeichnen, wenn die Geraden senkrecht aufeinander\n");
