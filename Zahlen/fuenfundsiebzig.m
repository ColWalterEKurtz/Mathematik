...
printf("      \\item Drei aufeinander folgende Zahlen ergeben die Summe 75.\n");
printf("            Schreibe die drei Zahlen auf.\n");
printf("      \\item Jetzt sollen vier aufeinander folgende Zahlen die Summe 75 ergeben.\n");
