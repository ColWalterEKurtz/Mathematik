...
printf("    Durchschnittsgeschwindigkeit von \\sikmh{5}, danach mit \\sikm{4}. Das\n");
...
printf("    Wie weit ist dann der Schulweg, und wie lange wäre das andere Kind unterwegs?\n");
printf("  \\fi\n");
