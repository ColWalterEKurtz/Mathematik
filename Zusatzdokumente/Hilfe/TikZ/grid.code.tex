...
\rule[-0.5ex]{0pt}{2.5ex}\hspace*{1.0em}\textcolor{G}{\textbf{\%~ein~Gitternetz~mit~verschiedenen~Schrittweiten}}\\
\rule[-0.5ex]{0pt}{2.5ex}\hspace*{1.0em}\textbackslash{}draw~(0,~0)~\textcolor{R}{\textbf{grid}}[\textcolor{R}{\textbf{xstep=3mm}},~\textcolor{R}{\textbf{ystep=2mm}}]~(3,~1);\\
