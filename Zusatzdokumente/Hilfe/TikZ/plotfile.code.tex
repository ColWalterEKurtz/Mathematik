...
\rule[-0.5ex]{0pt}{2.5ex}\hspace*{1.0em}\textcolor{G}{\textbf{\%~Koordinaten~aus~einer~Datei~laden}}\\
\rule[-0.5ex]{0pt}{2.5ex}\hspace*{1.0em}\textbackslash{}draw~\textcolor{R}{\textbf{plot}}[\textcolor{R}{\textbf{smooth}}]~\textcolor{R}{\textbf{file}}\{spirograph.xy\};\\
