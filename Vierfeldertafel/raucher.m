...
printf("    250 Schülerinnen gaben an, nicht zu rauchen.\n");
...
printf("            Person weiblich und Nichtraucherin?\n");
printf("      \\item Mit welcher Wahrscheinlichkeit ist eine Schülerin Nichtraucherin?\n");
printf("      \\item Untersuche ob in diesem Fall die Merkmale \\textit{Geschlecht}\n");
